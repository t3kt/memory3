...
namespace {
  class ParAccessor {
  public:
    explicit ParAccessor(const TD::OP_Inputs& i) : inputs(i) {}
    ...
    TD::Vector getVector(const std::string& name) const {
      double x, y, z;
      inputs.getParDouble3(name.c_str(), x, y, z);
      return { static_cast<float>(x), static_cast<float>(y), static_cast<float>(z) };
    }
    TD::Color getRGBAColor(const std::string& name) const {
      double r, g, b, a;
...
namespace tekt {
  ...
  void BoolParameter::load(const TD::OP_Inputs& inputs) {
  ...
  void StringParameter::load(const TD::OP_Inputs& inputs) {
    ParAccessor pars{ inputs };
  ...
  template <>
  void NumericParameter<float>::load(const TD::OP_Inputs& inputs) {
    ParAccessor pars{ inputs };
    value = pars.getFloat(name);
  }

  template <>
  void NumericParameter<int>::load(const TD::OP_Inputs& inputs) {
    ParAccessor pars{ inputs };
  ...
  template <>
  void ValueRangeParameter<float>::load(const TD::OP_Inputs& inputs) {
    ParAccessor pars{ inputs };
  ...
  void VectorParameter::load(const TD::OP_Inputs& inputs) {
    ParAccessor pars{ inputs };
  ...
  void RGBAColorParameter::load(const TD::OP_Inputs& inputs) {
    ParAccessor pars{ inputs };
  ...
  void VectorRangeParameters::load(const TD::OP_Inputs& inputs) {
    low.load(inputs);
    high.load(inputs);
  }
