...
namespace tekt {
  ...
  public:
    ...
    void applyTo(TD::OP_NumericParameter& p, std::size_t i = 0) const {
  ...
  private:
    void applyTo(TD::OP_NumericParameter& p) const {
  ...
  class ParBuilder {
  public:
    ParBuilder(TD::OP_ParameterManager* m, std::string page) : _manager(m), _page(std::move(page)) {}
  ...
  private:
    ...
    static void check(const ParOpts& opts, TD::OP_ParAppendResult res) {
      assert(res == TD::OP_ParAppendResult::Success);
    }

    TD::OP_ParameterManager* _manager;
  ...
  public:
    ...
    virtual void load(const TD::OP_Inputs& inputs) = 0;
  ...
  public:
    ...
    void load(const TD::OP_Inputs& inputs) override;
  ...
  public:
    ...
    void create(ParBuilder& pars) const override;
    void load(const TD::OP_Inputs& inputs) override;
    const TD::Vector& get() const { return values; }
  private:
  ...
  public:
    ...
    const TD::Color& get() const { return values; }
  private:
  ...
  public:
    ...
    ValueRange<TD::Vector> get() const { return { low.get(), high.get() };}
  };
