...
void ChannelMap::getChannelName(int32_t index, TD::OP_String* name) const {
...
ChannelMap& ChannelMap::addFromInput(const TD::OP_CHOPInput* input)
{
...
const float* ChannelMap::inputData(const TD::OP_CHOPInput* input, const std::string& name)
{
...
float* ChannelMap::outputData(TD::CHOP_Output* output, const std::string& name) const
{
