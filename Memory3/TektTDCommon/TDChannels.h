...
namespace tekt {
  ...
  public:
    ...
    ChannelMap& addFromInput(const TD::OP_CHOPInput* input);
    ...
    const float* inputData(const TD::OP_CHOPInput* input,
                           const std::string& name);

    float* outputData(TD::CHOP_Output* output,
    ...
    template<std::size_t N>
    InputChannelTuple<N> inputDataTuple(const TD::OP_CHOPInput* input,
    ...
    template<std::size_t N>
    OutputChannelTuple<N> outputDataTuple(TD::CHOP_Output* output,
    ...
    void getChannelName(int32_t index, TD::OP_String* name) const;
  ...
  public:
    ...
    virtual void attachOutput(TD::CHOP_Output* outputs, const ChannelMap& chans) = 0;
  ...
  public:
    ...
    void attachOutput(TD::CHOP_Output* outputs, const ChannelMap& chans) override {
  ...
  using VectorOutChannel = OutputChannel<TD::Vector>;
  using ColorOutChannel = OutputChannel<TD::Color>;
  ...
  public:
    ...
    virtual void detach() = 0;
    virtual void attachInput(const TD::OP_CHOPInput* inputs, ChannelMap& chans) = 0;
  };
  ...
  public:
    ...
    void attachInput(const TD::OP_CHOPInput* inputs, ChannelMap& chans) override {
  ...
  using VectorInChannel = InputChannel<TD::Vector>;
  using ColorInChannel = InputChannel<TD::Color>;
}
